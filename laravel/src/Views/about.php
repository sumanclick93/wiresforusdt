...
<div class="auth-card" style="max-width: 800px; width: 100%;">
    ...
    <div
        ...
        <div
            style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-top: 10px;">
            <!-- United States FinCEN MSB Card -->
            <div
                style="padding: 18px; background: rgba(18, 18, 22, 0.85); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 12px; font-size: 12px; line-height: 1.6; color: #d4d4d8; text-align: left;">
                <div
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        <span
                            style="font-size: 10px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; color: var(--accent-neon); display: block; margin-bottom: 2px;">CZECH
                            REPUBLIC &bull; EUROPE</span>
                        <strong style="font-size: 16px; color: #ffffff; display: block; line-height: 1.2;">Money
                            Services Business</strong>
                        <span style="font-size: 13px; color: #a1a1aa;">BURTEREX S.R.O.</span>
                    </div>
                    <span
                        style="border: 1px solid rgba(255, 255, 255, 0.2); border-radius: 4px; padding: 2px 8px; font-size: 11px; font-weight: 700; color: #e4e4e7;">CZ</span>
                </div>
                <div style="display: grid; grid-template-columns: 1fr; gap: 8px; font-size: 12px;">
                    <div><strong
                            style="color: #a1a1aa; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px; display: block;">MSB
                            REGISTRATION NO.</strong> <span
                            style="font-family: monospace; font-size: 13px; font-weight: 700; color: #fff;">31000274751182</span>
                    </div>
                    <div><strong
                            style="color: #a1a1aa; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px; display: block;">TRADE
                            LICENSE NO.</strong> <span
                            style="font-family: monospace; font-size: 13px; font-weight: 700; color: #fff;">19560851</span>
                        (Czech Republic Registration)</div>
                    <div><strong
                            style="color: #a1a1aa; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px; display: block;">REGISTERED
                            OFFICE ADDRESS</strong> Cimburkova 916/8, 130 00 Praha - Žižkov, Czech Republic</div>
                    <div><strong
                            style="color: #a1a1aa; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px; display: block;">REGISTERED
                            OFFICE AUTHORITY</strong> Veřejný rejstřík a Sbírka listin - Ministry of Justice</div>
                    <div>Powered by <a href="https://butterex.com" target="_blank" rel="noopener noreferrer"
                            style="color: var(--accent-neon); text-decoration: none; font-weight: 600;">Butterex.com</a>
                    </div>
                </div>
